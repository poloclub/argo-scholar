        ...
        <div className={classnames(Classes.DIALOG_BODY)}>
          {!this.state.selectedContinue && (
            <div>
              <p style={{ display: "inline", marginRight: "20px" }}>
                You can share your snapshot as
                <b> a public URL</b>, an <b> HTML iframe</b>, or a{" "}
                <b>Jupyter Notebook IFrame</b>
              </p>
              {!this.state.selectedContinue && (
                <Button
                  ...
                  onClick={async () => {
                    ...
                    if (requestSuccess) {
                      ...
                      toaster.show({
                        message:
                          "Failed to publish to sharing server. Please try again later.",
                        intent: Intent.DANGER,
                        timeout: -1,
                        iconName: "warning-sign",
                      });
              ...
              <div
                className="pt-callout pt-intent-warning"
                style={{ marginBottom: "20px" }}
              >
                <p className="pt-callout-title">
                  This snapshot is “static”, like taking a photo of your
                  visualization. This means that if your graph is changed in any
                  ways (e.g., move nodes around) after creating a URL and you
                  want to re-share those updates, you will need to create a new
                  URL by selecting <b>Share Again to a new URL</b> in the next
                  window.
                </p>
              </div>
              <div className="pt-callout pt-intent-danger">
                <p className="pt-callout-title ">
                  <b>IMPORTANT!</b> This will make your graph snapshot public.
                  If you are working with sensitive data (with custom access
                  control), or large data ({">"}400MB), please follow our guide
                  on Github to easily deploy your own sharing server.
                </p>
              </div>
            </div>
          )}
          {this.state.isFetching && (
            <p style={{ marginTop: "10px" }}>
              <b>Sharing in progress. Please wait...</b>
            </p>
          )}
          {this.state.selectedContinue && (
            <div>
